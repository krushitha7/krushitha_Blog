        ...
        <div className="col-lg-4 col-md-6 col-sm-6">
          <div className="card ">
            <div className="card-title text-center border-bottom">
              <h2 style={{fontFamily:'serif'}} className="p-2">Signin</h2>
            </div>
                ...
                <div className="mb-4">
                  ...
                  <div className="form-check form-check-inline">
                    <input
                      ...
                      {...register("userType")}
                    />
                    <label htmlFor="author" className="form-check-label" style={{ color: "#000000" }}>
                      Author
                    </label>
                  </div>
                  <div className="form-check form-check-inline">
                    <input
                      ...
                      {...register("userType")}
                    />
                    <label htmlFor="user" className="form-check-label" style={{ color: "#000000" }}>
                      User
                    </label>
                  </div>
                </div>
